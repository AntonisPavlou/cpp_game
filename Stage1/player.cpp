...
void Player::init()
{
	...
	m_brush_player.texture = m_state->getFullAssetPath("ninja1.png");

	m_sprites.push_back(m_state->getFullAssetPath("ninja2.png"));
	m_sprites.push_back(m_state->getFullAssetPath("ninja3.png"));
	m_sprites.push_back(m_state->getFullAssetPath("ninja4.png"));

}

void Player::draw()
{
	int s = (int)fmodf(m_pos_x, m_sprites.size());
...
void Player::debugDraw()
{
	...
	SETCOLOR(debug_brush.outline_color, 1, 0.3f, 0);
